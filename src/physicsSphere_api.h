...
extern "C" {
	 ...
	 */
	void physics_engine_destroy(void *physicsSphere) {
	 ...
	 */
	void physics_sphere_set_position(void *physicsSphere, float *position) {
	 ...
	 */
	void physics_sphere_set_rotation(void *physicsSphere, float *rotation) {
	 ...
	 */
	void physics_sphere_get_position(void *physicsSphere, float *position) {
	 ...
	 */
	void physics_sphere_get_rotation(void *physicsSphere, float *rotation) {
